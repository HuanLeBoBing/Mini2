Page({
  ...
  getResult: function() {
    ...
    wx.redirectTo({
      url: '/pages/three/two8/singleplayer3?aa='+this.data.a+"&bb="+this.data.b+"&cc="+this.data.c+"&dd="+this.data.d+"&ee="+this.data.e+"&ff="+this.data.f+"&r1="+this.data.result1+"&r2="+this.data.result2+"&r3="+this.data.result3
    })
  },
